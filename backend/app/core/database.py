...
_DEVELOPMENT_SCHEMA_PATCHES = (
    ...
    "ALTER TABLE IF EXISTS usuario ADD COLUMN IF NOT EXISTS last_login_at TIMESTAMPTZ",
    "ALTER TABLE IF EXISTS usuario ADD COLUMN IF NOT EXISTS last_login_ip VARCHAR(64)",
    "ALTER TABLE IF EXISTS usuario ADD COLUMN IF NOT EXISTS last_login_user_agent VARCHAR(300)",
